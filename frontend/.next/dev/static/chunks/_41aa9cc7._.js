...
function AppProvider(t0) {
    ...
    if ($[0] !== "a4069af2b6091357ffc13530c9cd739128980bb6b5a0c60a09892acf41b52123") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a4069af2b6091357ffc13530c9cd739128980bb6b5a0c60a09892acf41b52123";
    }
    const { children } = t0;
        ...
        t1 = ({
            "AppProvider[loadData]": async ()=>{
                ...
                try {
                    ...
                    const playersWithMatches = playersData.map({
                        "AppProvider[loadData > playersData.map()]": (player)=>({
                                ...player,
                                matches: matchesData.filter({
                                    "AppProvider[loadData > playersData.map() > matchesData.filter()]": (m)=>m.player1Id === player.id || m.player2Id === player.id
                                }["AppProvider[loadData > playersData.map() > matchesData.filter()]"]).map(_AppProviderLoadDataPlayersDataMapAnonymous)
                            })
                    }["AppProvider[loadData > playersData.map()]"]);
                    dispatch({
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = ({
            "AppProvider[reloadData]": async ()=>{
                await loadData();
            }
        })["AppProvider[reloadData]"];
        $[4] = t4;
    } else {
        t4 = $[4];
    }
    ...
    let t6;
    if ($[7] !== children || $[8] !== t5) {
        t6 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AppContext.Provider, {
            value: t5,
            children: children
        }, void 0, false, {
...
_c = AppProvider;
function _AppProviderLoadDataPlayersDataMapAnonymous(m_0) {
    return m_0.id;
}
function useApp() {
    _s1();
...
//# sourceMappingURL=_41aa9cc7._.js.map